...
warn "====aa_init: Basic initialization and re-initialization"
...
warn "====aa_clear: Clearing empty and populated arrays"
unset CLEAR_TEST
aa_init CLEAR_TEST
...
warn "====aa_clear: Error conditions"
# Undefined variable
...
warn "====aa_copy: Copy to existing populated array (should clear first)"
unset SRC2 DEST2
aa_init SRC2
...
warn "====aa_copy: Keys with special characters"
...
warn "====aa_update: Basic update operations"
...
warn "====aa_update: Updating with empty array"
...
warn "====aa_update: Values with special characters in update"
unset TARGET3 SRC3
aa_init TARGET3
...
warn "====aa_set_default: Setting defaults for missing keys"
unset DEFAULT_TEST
...
warn "====aa_set_default: Default values with special characters"
...
warn "====aa_len: Length of various types"
...
warn "====aa_len: Undefined variable"
unset UNDEF_LEN
...
warn "====aa_eq: Equal associative arrays"
unset AA_EQ1 AA_EQ2
aa_init AA_EQ1
aa_set AA_EQ1 k1 v1
aa_set AA_EQ1 k2 v2
...
warn "====aa_eq: Different lengths"
aa_set AA_EQ4 k1 v1
testRC 3 aa_eq AA_EQ3 AA_EQ4


warn "====aa_eq: Empty arrays"
unset EMPTY1 EMPTY2
aa_init EMPTY1
aa_init EMPTY2
...
warn "====aa_has: Keys with special characters"
unset HAS_TEST
aa_init HAS_TEST
...
warn "====aa_set/aa_get: Empty string values"
...
warn "====aa_set/aa_get: Whitespace values"
...
warn "====aa_set/aa_get: Values with newlines and tabs"
...
warn "====aa_unset: Remove non-existent key"
testRC FAIL aa_unset -q UNSET_TEST k_not_there


warn "====aa_unset: Remove keys with special characters"
...
warn "====aa_append_value: Append to existing value"
unset APPEND_TEST
aa_init APPEND_TEST
...
warn "====aa_insert_value: Insert at beginning"
unset INSERT_TEST
aa_init INSERT_TEST
...
warn "====aa_find_key: Exact matches"
unset FIND_TEST
aa_init FIND_TEST
...
warn "====aa_find_key: Case-insensitive matching"
...
warn "====aa_find_key: Case-insensitive with ambiguity"
...
warn "====aa_find_key: Empty string key"
...
warn "====aa_get_abbrev: Get value by abbreviation"
unset ABBREV_TEST
aa_init ABBREV_TEST
...
warn "====aa_get_abbrev: Default for non-existent key"
testOutput "default_value" aa_get_abbrev -d default_value ABBREV_TEST xyz


warn "====aa_get_abbrev: No default for ambiguous key (should fail)"
testRC 2 aa_get_abbrev -q -d fallback ABBREV_TEST ver


warn "====aa_get_abbrev: Case-insensitive"
...
warn "====aa_export: HTML table format"
...
warn "====aa_export: With --lines option"
...
warn "====aa_export: Special characters in values"
...
warn "====STRESS: Large number of keys"
unset STRESS_TEST
aa_init STRESS_TEST
local -i i
for (( i=1; i<=100; i++ )); do
...
warn "====STRESS: Unicode/UTF-8 characters"
unset UTF8_TEST
aa_init UTF8_TEST
...
warn "====INTERACTION: Copy then update"
...
warn "====INTERACTION: Clear then operations"
aa_clear INT_DEST
...
warn "====INTERACTION: Append then insert"
unset INT_MOD
aa_init INT_MOD
